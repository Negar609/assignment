...
function jquerySelectors() {
  ...
  // CSS .red { color: red; }
  // $('.red').css('color', 'red'); // jquery
  // DOM list returned from `querySelectorAll`
  ...
  // a recommened jQuery css method accepts an object of CSS rules
  // $('.red.twenty').css({
  //   'border-bottom-width': '1px',
  //   'border-bottom-style': 'dotted',
  // });
  // a recommened jQuery chaining may occur after a selector
  // $('.red.twenty')
